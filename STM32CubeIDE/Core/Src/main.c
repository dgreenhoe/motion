...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_GREEN_Pin|PB2_GPIO_XDCSN_MM_Pin|PB12_PROTO6_Pin|LED_RED_Pin
                          |PB15_PROTO7_Pin|GPIO_PIN_4|PB5_PROTO3_Pin|GPIO_PIN_6
                          |GPIO_PIN_7|PB8_PROTO9_Pin|PB9_PROTO10_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, PG0_BUF_OE__Pin|PG1_Out_LED3_Pin|GPIO_PIN_3|GPIO_PIN_4
                          |GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_9
                          |GPIO_PIN_10|GPIO_PIN_12|GPIO_PIN_14|GPIO_PIN_15, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10|PD11_GPIO_MP3CSN_MM_Pin|GPIO_PIN_14|GPIO_PIN_15
                          |PD0_GPiO_LED6_Pin|PD1_GPiO_LED5_Pin|GPIO_PIN_2|GPIO_PIN_4
  ...
  /*Configure GPIO pins : LED_GREEN_Pin PB2_GPIO_XDCSN_MM_Pin PB12_PROTO6_Pin LED_RED_Pin
                           PB15_PROTO7_Pin PB4 PB5_PROTO3_Pin PB6
                           PB7 PB8_PROTO9_Pin PB9_PROTO10_Pin */
  GPIO_InitStruct.Pin = LED_GREEN_Pin|PB2_GPIO_XDCSN_MM_Pin|PB12_PROTO6_Pin|LED_RED_Pin
                          |PB15_PROTO7_Pin|GPIO_PIN_4|PB5_PROTO3_Pin|GPIO_PIN_6
                          |GPIO_PIN_7|PB8_PROTO9_Pin|PB9_PROTO10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PG0_BUF_OE__Pin PG1_Out_LED3_Pin PG3 PG4
                           PG5 PG6 PG8 PG9
                           PG10 PG12 PG14 PG15 */
  GPIO_InitStruct.Pin = PG0_BUF_OE__Pin|PG1_Out_LED3_Pin|GPIO_PIN_3|GPIO_PIN_4
                          |GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_9
  ...
  /*Configure GPIO pins : PD10 PD11_GPIO_MP3CSN_MM_Pin PD14 PD15
                           PD0_GPiO_LED6_Pin PD1_GPiO_LED5_Pin PD2 PD4
                           PD7 */
  GPIO_InitStruct.Pin = GPIO_PIN_10|PD11_GPIO_MP3CSN_MM_Pin|GPIO_PIN_14|GPIO_PIN_15
                          |PD0_GPiO_LED6_Pin|PD1_GPiO_LED5_Pin|GPIO_PIN_2|GPIO_PIN_4
                          |GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PA8 PA15_PROTO5_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_8|PA15_PROTO5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
